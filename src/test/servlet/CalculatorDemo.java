...
public class CalculatorDemo {
	...
	class OPtionHandle implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			 ...
			 * if(option.equals("cos")){ a=Double.parseDouble(text1.getText());
			 * double b=Math.cos(a/180*Math.PI);
			 * text1.setText(String.valueOf(b)); } if(option.equals("tan")){
			 * a=Double.parseDouble(text1.getText()); double
			 * b=Math.tan(a/180*Math.PI); text1.setText(String.valueOf(b)); }
			 * if(option.equals("log")){ a=Double.parseDouble(text1.getText());
			 * double b=Math.log(a)/Math.log(10.0);
			 * text1.setText(String.valueOf(b)); } if(option.equals("sqrt")){
			 * a=Double.parseDouble(text1.getText()); double b=Math.sqrt(a);
			 * text1.setText(String.valueOf(b)); } if(option.equals("pow")){
			 * //该运算含有两个操作数 a=Double.parseDouble(text1.getText()); fh=4; //
			 * text1.setText(""); //将文本域的内容清空 } if(option.equals("exp")){
			 * a=Double.parseDouble(text1.getText()); b=a; double b=Math.exp(a);
			 * text1.setText(String.valueOf(b)); } if(option.equals("求倒")){
